...
public class ControlPanel extends JPanel {
    ...
    private final JComboBox<String> start = new JComboBox<>();
    ...
    public ControlPanel(Graph<Node<String>, Edge<Node<String>>> g, GraphPanel gp, ResultPanel rp) {
        ...
        add(section("1. Calculate Alternative Routes",
    ...
    private static String val(JComboBox<String> b) {
        Object v = b.getSelectedItem();
    ...
    private JPanel section(String title, JComponent... items) {
        ...
        p.setMaximumSize(new Dimension(240, 420));
        for (int i = 0; i < items.length; i++) {
            p.add(items[i]);
            if (i < items.length - 1) p.add(Box.createVerticalStrut(6));
        }
        return p;
    }
    ...
    private JButton button(String t, Runnable r) {
        return button(t, r, new Color(55, 70, 95));
    }
    ...
    private JButton button(String t, Runnable r, Color bg) {
        ...
        b.setMaximumSize(new Dimension(220, 28));
